...
@pytest.mark.parametrize(
    ...
    [
        ...
        # tests for resample_cube_temporal process with valid_within param
        # is_valid process is needed, so it is naively loaded with load_dependency_processes_code
        # additional tests for this are in test_integration.py
        # data shape
        # bands:  B1, B2
        # date 1: 1, 11,
        # date 2: 2, 12,
